...
class Admin
{
    ...
    public function __construct()
    {
        ...
        add_filter('wpmu_signup_user_notification', [$this, 'disableEmailVerificationNetwork'], 10, 4);
        add_action('admin_footer', [$this, 'disableEmailVerification']);
        add_action('admin_footer', [$this, 'hideEmailVerificationNetworkLabel']);
    }
